...
/**
 * Created by laliu on 2015/10/7.
 */
public class ColorPickerDialog extends Dialog {
    Context mContext;
    private String title; // Title for Dialog
    private int mInitialColor; // Original Color
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ColorPickerView myView = new ColorPickerView(mContext, height, width);
    ...
    private class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            // Show circle of the center circle
